...
struct EduAgentGraphOperationEnvelope: Decodable {
    let assistantReply: String
    let thinkingTraceMarkdown: String?
    let operations: [EduAgentGraphOperation]
...
struct EduAgentGraphOperation: Decodable {
    let op: String
    let tempID: String?
    let nodeRef: String?
    ...
    let textFieldValues: [String: String]?
    let optionFieldValues: [String: String]?
    let anchorNodeRef: String?
